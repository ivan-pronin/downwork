...
public class IdealistaAdUrlsFilter implements IAdUrlsFilter
{
    private static final Logger LOGGER = LogManager.getLogger(IdealistaAdUrlsFilter.class);
    ...
    public List<WebElement> filterAdUrls(List<WebElement> advertisementElements)
    {
        ...
        filteredList.addAll(advertisementElements
                .stream().filter(e -> searchActions
                        .findElementsByXpath(e, "//descendant::div[contains(@class,'logo-branding')]").isEmpty())
