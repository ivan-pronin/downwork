    ...
    private List<Category> createCategories() throws MalformedURLException
    {
        return Arrays.asList(
                new Category(new URL("https://www.fotocasa.es/es/comprar/casas/madrid-capital/todas-las-zonas/l"),
                        null),
                new Category(
                        new URL("https://www.fotocasa.es/comprar/obra-nueva/madrid-capital/listado-por-foto?crp=2&ts=madrid%20capital,%20madrid&llm=724,14,28,173,0,28079,0,0,0&opi=36&ftg=false&pgg=true&odg=false&fav=false&grad=false&fss=false&mode=1&cu=es-es&craap=1&fs=false"),
                        null),
                new Category(
                        new URL("https://www.fotocasa.es/comprar/obra-nueva/madrid-capital/listado?crp=2&ts=madrid%20capital,%20madrid&llm=724,14,28,173,0,28079,0,0,0&opi=36&ftg=false&pgg=true&odg=false&fav=false&grad=false&fss=false&mode=3&cu=es-es&craap=1&fs=false&tta=0"),
                        null));
    }
}
