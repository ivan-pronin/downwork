...
import com.idealista.scraper.ui.actions.ProxyClickActions;
import com.idealista.scraper.ui.actions.ProxySearchActions;
import com.idealista.scraper.ui.actions.ProxyWaitActions;
...
public class ProxyFetcher
{
    ...
    @Autowired
    private ProxySearchActions searchActions;

    @Autowired
    private ProxyWaitActions waitActions;

    @Autowired
    private ProxyClickActions clickActions;
    ...
    {
        List<Integer> proxySources = scraperConfiguration.getProxySources();
