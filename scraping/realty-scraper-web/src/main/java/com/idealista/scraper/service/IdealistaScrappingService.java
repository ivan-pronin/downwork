...
public class IdealistaScrappingService implements IScrappingService
{
    ...
    public void scrapSite() throws InterruptedException, MalformedURLException
    {
        ...
        filterAttributes.setPublicationDateFilter(sourceConfiguration.getPublicationDateFilter());
        ...
        context.setProvince(sourceConfiguration.getProvince());
        ...
        int maxAdsToProcess = scraperConfiguration.getMaxAdsToProcess();
    ...
    private Map<IGenericSearchAttributes, Set<String>> getAttributesMap()
    {
        return new HashMap<IGenericSearchAttributes, Set<String>>()
        {
            ...
            {
                put(IdealistaSearchAttributes.OPERATION,
                        new HashSet<>(Arrays.asList(sourceConfiguration.getOperation())));
                put(IdealistaSearchAttributes.TYPOLOGY,
                        new HashSet<>(Arrays.asList(sourceConfiguration.getTypology().getEnAlias())));
                put(IdealistaSearchAttributes.LOCATION,
                        new HashSet<>(Arrays.asList(sourceConfiguration.getLocation())));
            }
        };
    }
