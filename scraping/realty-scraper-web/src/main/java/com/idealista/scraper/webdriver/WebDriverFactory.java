...
public class WebDriverFactory implements IWebDriverFactory
{
    ...
    public WebDriver create(ProxyAdapter proxy, DriverType type)
    {
        ...
        if (scraperConfiguration.isUseLightweightedChrome())
        {
        ...
        // if (!scraperConfiguration.isJavascriptEnabled())
        // {
        // cap.setJavascriptEnabled(false);
        // cap.setCapability("chrome.switches", Arrays.asList("--disable-javascript"));
        // }
        /*
         * LOGGER.info("ChromeDriverService is running: {}", service == null ? "service is null" : service.isRunning());
        ...
        switch (type)
        {
            case CHROME:
                /*
                 * if (scraperConfiguration.useChromeService())
                 * {
        ...
        if (scraperConfiguration.maximizeBrowserWindow())
        {
